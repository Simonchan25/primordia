...
const DOC = [
  ...
  "It comes in three chambers — and the first two tell one story twice.  Origin: a handful of particles, each obeying a single blind rule — who to approach, who to flee.  None of them knows what a cell is. Yet at scale, they grow cells, membranes, hunters, whole ecosystems.  Then Flux: soften those points into one continuous field, and the same miracle returns — bodies that swim, and heal, and refuse to die.  Self-organization, spoken in two languages. Design, with no designer.",
  "The third chamber, Becoming, is the hardest. Here, life learns to keep itself.  Each creature carries a genome, and a small brain that can grow.  They hunger, they hunt, they reproduce, they die.  I never told them to survive — there is no goal, no score.  Yet they learn. This is natural selection. You are watching it think.",
